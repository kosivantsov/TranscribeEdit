...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QTableWidget, QTableWidgetItem, QHeaderView, QKeySequenceEdit, QLabel
...
class ShortcutsTab(QWidget):
    ...
    def __init__(self, parent, settings, current_shortcuts):
        ...
        info = QLabel(self.tr("Configure keyboard shortcuts for the application. Click a shortcut cell and press the new key combination to rebind it."))
        ...
        for i, (name, default_seq) in enumerate(DEFAULT_SHORTCUTS.items()):
